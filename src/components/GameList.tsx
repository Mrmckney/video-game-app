...
export const GameList = ({gameData}: GameProps): JSX.Element => {
    ...
    const loadFavorites = async () => {
        const response: Response = await fetch(`https://video-game-api-six.vercel.app/favorites`, {
            method: 'GET',
            headers: {
    ...
    const handleFavorite = async (game: Game) => {
        const response: Response = await fetch(`https://video-game-api-six.vercel.app/addfav`, {
            method: 'PATCH',
            headers: {
    ...
    const handleRemoveFav = async (game: Game) => {
        const response: Response = await fetch(`https://video-game-api-six.vercel.app/removefav`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer: ${user}`
